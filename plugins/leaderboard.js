...
• *Tabla de los pendejos mas pendejos ${len}* •
...
handler.help = ['Ranking [Número de usuarios]', 'rk [Número de usuarios]']
handler.tags = ['xp']
handler.command = /^(ranking|rk)$/i
handler.owner = false
handler.mods = false
