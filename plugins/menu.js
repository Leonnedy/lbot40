...
let handler  = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    let tags = {
      'main': 'Principal',
      'game': 'Juego',
      'xp': 'Experiencia & Limite',
      'sticker': 'Stickers',
      'kerang': 'Magia y Brillitos',
      'quotes': 'Frases poeticas',
      'admin': 'Admin',
      'group': 'Grupo',
      'premium': 'Premium',
      'internet': 'Internet',
...
│ Nivel *%level (%exp / %maxexp)* [%xp4levelup Para aumentar tu nivel de pendejez]
...
│ Cantidad de personas interactuando con el bot: %rtotalreg of %totalreg
│ Github de Leo uWu:
│ %github
╰────
%readmore`
