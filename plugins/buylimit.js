...
let handler = async (m, { conn, command, args }) => {
  ...
  } else conn.reply(m.chat, `Ya mamaste, se te acabaron los puntos ${count} limit`, m)
}
handler.help = ['Comprar<número de límites>', 'comprar <número de límites>', 'comprartodo']
handler.tags = ['xp']
handler.command = /^comprar([0-9]+)|buy|comprartodo$/i
handler.owner = false
handler.mods = false
